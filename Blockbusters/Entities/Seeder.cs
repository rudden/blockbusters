		...
		public async Task Seed()
		{
			...
			if (!_context.Videos.Any())
			{
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 154,
					VideoType = VideoType.DVD.ToString(),
					Genre = string.Join(", ", new List<string>{ Genre.Crime.ToString(), Genre.Drama.ToString() }),
					Price = 39,
					FromYear = "1994",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 125,
					VideoType = VideoType.DVD.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Anime.ToString(), Genre.Fantasy.ToString(), Genre.Family.ToString() }),
					Price = 29,
					FromYear = "2001",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 113,
					VideoType = VideoType.VHS.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Crime.ToString(), Genre.Drama.ToString() }),
					Price = 29,
					FromYear = "1976",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 106,
					VideoType = VideoType.Bluray.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Action.ToString(), Genre.Thriller.ToString(), Genre.Drama.ToString() }),
					Price = 59,
					FromYear = "2017",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 127,
					VideoType = VideoType.VHS.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Thriller.ToString(), Genre.Adventure.ToString(), Genre.SciFi.ToString() }),
					Price = 29,
					FromYear = "1993",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 81,
					VideoType = VideoType.DVD.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Comedy.ToString(), Genre.Family.ToString(), Genre.Adventure.ToString(), Genre.Fantasy.ToString() }),
					Price = 29,
					FromYear = "1993",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 180,
					VideoType = VideoType.Bluray.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Comedy.ToString(), Genre.Crime.ToString(), Genre.Drama.ToString() }),
					Price = 49,
					FromYear = "2013",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 98,
					VideoType = VideoType.DVD.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Thriller.ToString(), Genre.Crime.ToString(), Genre.Drama.ToString() }),
					Price = 19,
					FromYear = "1993",
				...
				_context.Videos.Add(new Video
				{
					...
					LengthInMinutes = 148,
					VideoType = VideoType.DVD.ToString(),
					Genre = string.Join(", ", new List<string> { Genre.Adventure.ToString(), Genre.Drama.ToString() }),
					Price = 29,
					FromYear = "2007",
